...
- Fixed TalkBack crash in notification profile detail screen by moving profile loading to initState using addPostFrameCallback (ensures controllers are populated before widget tree is built for accessibility)
